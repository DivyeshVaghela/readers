...
<div>
	...
	<sf:form modelAttribute="createReadlistModel" method="POST" class="form-horizontal">
		...
		<div class="form-group">
			<div class="col-md-offset-3 col-md-6 col-sm-offset-2 col-sm-8">
				<c:choose>
					<c:when test="${empty createReadlistModel.id}">
						<button type="submit" class="btn btn-primary pull-right">Create Readlist</button>
					</c:when>
					<c:when test="${not empty createReadlistModel.id}">
						<sf:hidden path="id"/>
